   ...
   begin
      loop
         ...
         if Mode < 1 then
            ...
            objThink.setDrive(Analog_Value(L), Analog_Value(R), Forward);  
         else
            if (yVal < 150 and yVal > 100 and xVal < 150 and xVal > 100) then
               objThink.setDriveUni(False, False, False, False, 0, 0);    -- STOPPED
            elsif (yVal < 150 and yVal > 100 and xVal < 256 and xVal > 200) then
               objThink.setDriveUni(True, False, False, True, 512, 512);  -- LEFT
            elsif (yVal < 256 and yVal > 200 and xVal < 150 and xVal > 100) then
               objThink.setDriveUni(True, True, True, True, 512, 512);    -- FORWARD
            elsif (yVal < 100 and yVal >= 0 and xVal < 150 and xVal > 100) then
               objThink.setDriveUni(False, False, False, False, 512, 512); -- REVERSE
            elsif (yVal < 150 and yVal > 100 and xVal < 100 and xVal >= 0) then
               objThink.setDriveUni(False, True, True, False, 512, 512);   -- RIGHT
            end if;
         end if;
